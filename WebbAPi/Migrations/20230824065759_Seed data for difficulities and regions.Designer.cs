...
namespace WebbAPi.Migrations
{
    ...
    [Migration("20230824065759_Seed data for difficulities and regions")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebbAPi.Models.Domain.Difficulty", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("WebbAPi.Models.Domain.Region", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("WebbAPi.Models.Domain.Walk", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("WebbAPi.Models.Domain.Walk", b =>
                {
                    b.HasOne("WebbAPi.Models.Domain.Difficulty", "Difficulty")
                        .WithMany()
                        .HasForeignKey("DifficultyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WebbAPi.Models.Domain.Region", "Region")
                        .WithMany()
